...
public class DialogFragmentTimePicker extends DialogFragment {
    ...
    public static DialogFragmentTimePicker newInstance(TimePickerDialog.OnTimeSetListener listener) {
        onTimeSetListener = listener;
        DialogFragmentTimePicker fragment = new DialogFragmentTimePicker();
        return fragment;
    }
